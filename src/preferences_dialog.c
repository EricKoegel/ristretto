...
rstto_preferences_dialog_init ( RsttoPreferencesDialog *dialog )
{
    ...
    g_object_set (G_OBJECT (dialog->priv->display_tab.quality_label), "yalign", 0.5f, NULL);
    ...
    g_object_set (G_OBJECT (dialog->priv->fullscreen_tab.hide_thumbnails_fullscreen_lbl), "yalign", 0.5f, NULL);
    ...
    g_object_set (G_OBJECT (dialog->priv->fullscreen_tab.clock_label), "yalign", 0.5f, NULL);
    ...
    g_object_set (G_OBJECT (timeout_lbl), "yalign", 0.5f, NULL);
    ...
    g_object_set (G_OBJECT (behaviour_desktop_lbl), "yalign", 0.5f, NULL);
    gtk_box_pack_start (
